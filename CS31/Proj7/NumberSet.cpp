...
namespace cs31
{
    ...
    bool NumberSet::notFound( int value ) const
    {
		...
		if (value == mOne) result = false;
		else if (value == mTwo) result = false;
		else if (value == mThree) result = false;
		else if (value == mFour) result = false;
		else if (value == mFive) result = false;
		else if (value == mSix) result = false;
		else if (value == mSeven) result = false;
		else if (value == mEight) result = false;
