...
#include "Sequence.h"
#include <limits>
//Works fine without a copy construtor - no dynamic memory usage, no inter class relationships...
//Also can I assume that it's sorted because only insert(*arg) is called...
